...
namespace GXPEngine
{
    public class Scene : GameObject
    {
        ...
        public Vec2[] verticies = new Vec2[] { new Vec2(289, 1048), new Vec2(300, 1018), new Vec2(115, 892), new Vec2(104, 871), 
            ...
            new Vec2(591, 136), new Vec2(595, 115), new Vec2(609, 94), new Vec2(628, 83), new Vec2(650, 80), new Vec2(660, 80), new Vec2(687, 91), 
            new Vec2(707, 115), new Vec2(709, 148), new Vec2(693, 174), new Vec2(682, 184), new Vec2(668, 189), new Vec2(682, 213), 
