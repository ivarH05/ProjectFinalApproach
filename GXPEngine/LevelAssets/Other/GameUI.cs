...
namespace GXPEngine.LevelAssets.Other
{
    ...
    {
        public static EasyDraw Objective = new EasyDraw(1000, 200, false);
        public static EasyDraw Progress = new EasyDraw(600, 200, false);

        public GameUI()
        {
            Progress.Position = new Vec2(955, 680);
            Objective.Position = new Vec2(940, 820);
            Progress.TextAlign(CenterMode.Center, CenterMode.Center);
            Objective.TextAlign(CenterMode.Center, CenterMode.Center);
            Progress.TextFont(Utils.LoadFont("Assets/WishMF.ttf", 48));
        ...
        public void Update()
        {
            ...
            Objective.Fill(255);
            Objective.Text(ObjectiveManager.GetObjectiveText(), 500, 100);
